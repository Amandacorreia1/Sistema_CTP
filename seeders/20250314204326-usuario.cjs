...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('Usuarios', [
      ...
      { matricula: 1006123657, nome: 'Fernanda Costa', senha: hashedPasswords[5], email: 'fernanda.costa@example.com', cargo_id: 5, createdAt: now, updatedAt: now },
      { matricula: 1000000001, nome: 'Admin', senha: hashedPasswords[6], email: 'admin@example.com', cargo_id: 6, createdAt: now, updatedAt: now } 
    ]);
  },
